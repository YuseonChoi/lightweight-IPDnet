...
class opt():
    ...
    def dir(self):
        ...
        # dirs['data'] = work_dir + '/IPDnet/data'   # 디버깅
        dirs['data'] = work_dir + '/data'  # 서버
        ...
        # experimental data
        dirs['sensig_train'] = dirs['data'] + '/train_cprd'
        dirs['sensig_dev'] = dirs['data'] + '/dev_cprd'
        dirs['sensig_test'] = dirs['data'] + '/test_cprd'
        # experimental data
